defmodule Snitch.Core.Tools.MultiTenancy.Repo do
  ...
  def insert_all(arg1, arg2, arg3 \\ []), do:
    Repo.insert_all(arg1, arg2, arg3 ++ get_opts())

  def update(args), do:
    Repo.update(args, get_opts())

  def update!(args), do:
    Repo.update!(args, get_opts())

  def load(arg1, arg2), do:
      Repo.load(arg1, arg2)

  def load(arg1, arg2, _), do:
    Repo.load(arg1, arg2)

  def update_all(arg1, arg2), do:
    Repo.update_all(arg1, arg2, get_opts())

  def delete(args), do:
    Repo.delete(args, get_opts())

  def delete_all(args), do:
    Repo.delete_all(args, get_opts())
  ...
  def preload(arg1, arg2), do:
    Repo.preload(arg1, arg2)
